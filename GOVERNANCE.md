...
semrel-plugins is an open source project governed by its maintainers and community contributors. This repository hosts the SemRels plugin SDK and official plugins maintained by the project.

## Scope

This governance applies to plugin SDK code, release automation, workflows, and repository documentation.
